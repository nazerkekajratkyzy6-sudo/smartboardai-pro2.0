...
function generateQR() {
  ...
  if (typeof QRCode !== "undefined") {
    try {
      ...
      qrDiv.innerHTML = `<img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${encodeURIComponent(url)}" width="150" height="150" style="border-radius:6px;" alt="QR"/>`;
    }
  } else {
    qrDiv.innerHTML = `<img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${encodeURIComponent(url)}" width="150" height="150" style="border-radius:6px;" alt="QR"/>`;
  }
